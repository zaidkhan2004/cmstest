...
$sql="SELECT max(patient_id) MX from patient";
      ...
      <div class="right_col" role="main">
        <div class="">
          ...
          <div class="col-xs-12">
            ...
            <div class="x_panel">
              <div class="x_title">
                <h2>You need to register as patient first in order to book appointment</h2>
                ...
                <div class="box-body">
                  <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="patient_id" class="form-control" disabled>
                                            <input type="hidden" id="h_patient_id" value="<?php echo $h_patient_id; ?>">
                                        </div>
...
var h_patient_id = $("#h_patient_id").val();
h_patient_id = parseInt(h_patient_id);
$("#patient_id").val(h_patient_id+1);
...
$("#book_appointment").html('<br><a href="online_appointment.php?patient_id='+patient_id+'" target="_blank"> Book Appointment </a><br>');
