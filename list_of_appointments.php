            ...
            <div class="right_col" role="main">
                    ...
                    <div class="page-title col-xs-12">
                        <div class="title_left">
                            <h3>Report: All Appointments List</h3>
                        </div>
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="x_panel">
                                ...
                                <div class="box-body">
                                    <div class="col-md-6">
                                        ...
                                        <div id="patient_details" class="form-group">
 											<?php 
                                           $sql= "select a.appointment_id,a.patient_id,a.consultant_id,a.date,a.time_slot, u.name  consultant_name,p.name patient_name,t.start_from, t.end_at from appointment a, users u, patient p, time_slot t where a.patient_id=p.patient_id and a.consultant_id=u.user_id and a.time_slot = t.time_slot_id;";
						 ...
						 <td>'.$row['date'].'</td>
						 <td>'.$row['start_from'].'-'.$row['end_at'].'</td>';
                                               echo'</tr>';
                                                $counter++;
                                                } // end of while 
                                                echo '</tbody></table>	<br>';
