                ...
                <div class="box-body">
                  <div class="col-md-6">
  										...
  										<div id="patient_details" class="form-group">
 											<?php 
                                           $sql= "select v.visit_id,v.patient_id,v.visit_date,v.visit_start_time,p.name patient_name from visit v, patient p where v.patient_id=p.patient_id;";
