...
$skip_consultation = $_POST['skip_consultation'];



$sql = "INSERT INTO visit (patient_id,visit_date,visit_start_time,skip_consultation) VALUES ($patient_id,'$visit_date','$visit_start_time',$skip_consultation)";
...
echo '<br><label> No of Points: '.sizeof($points).'</label>';
...
$additional_points = $_POST['points'];
$no_of_additional_points = sizeof($additional_points);
$current_time =  date('h:i:s');
...
if(isset($additional_points)){
for ($i=0; $i<sizeof($additional_points);$i++) { 
$sql = "INSERT INTO visit_points (visit_id,point_id,entryby) VALUES ($visit_id,$additional_points[$i],'T')";
