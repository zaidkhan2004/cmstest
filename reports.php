                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <div class="box-body">
                                    <div class="col-md-6">
									<form action="list_of_all_patients.php" target="_blank" method="post"> 
									 <input type="submit" id="list_of_patients" value="List of All Patients">
                                     </form>
                                     <br><br>
                                     <form action="list_of_appointments.php" target="_blank" method="post"> 
									 <input type="submit" id="list_of_appointments" value="List of All Appointments">
                                     </form>
                                     <br><br>
                                     <form action="list_of_visits.php" target="_blank" method="post"> 
									 <input type="submit" id="list_of_visits" value="List of All Visits">
                                     </form>
                                     <br><br>
                                     <form action="list_of_consultations.php" target="_blank" method="post"> 
									 <input type="submit" id="list_of_consultations" value="List of All Consultations">
                                     </form>
                                      <!--<br><br>
                                     <form action="list_of_treatments.php" target="_blank" method="post"> 
									 <input type="submit" id="list_of_treatments" value="List of All Treatments">
                                     </form> -->      
                                     <br><br>
                                     <form action="list_of_success_diseases.php" target="_blank" method="post"> 
									 <input type="submit" id="list_of_success_diseases" value="Success Percentage of Diseases Cured by Cupping">
                                     </form>
                                    </div><!-- /.col-md-6 -->
