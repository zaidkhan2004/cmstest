...
$('#patient_detail_table').DataTable( {
		...
		'columnDefs': [ {
            'targets': -1,
            'data': null,
            'defaultContent': '<input type="button" id="create" value="Create Visit">'
        }
 ...
 $('#patient_detail_table tbody').on( 'click', '#create', function () {
		var table = $('#patient_detail_table').DataTable();
        var data = table.row( $(this).parents('tr') ).data();
        window.open('visit.php?patient_id='+data[0]);
