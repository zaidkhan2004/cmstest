            ...
            <div class="right_col" role="main">
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="x_panel">
                                ...
                                <div class="box-body">
                                    <div class="col-md-6">
										...
										if ($user_gender == 'F' and $user_role != 1) { 
											$sql= "select p.patient_id,p.name,p.gender,p.age,p.mobile_no,p.reg_date,v.visit_id from patient p,visit v where p.gender='F' and v.visit_date =  '$current_date' and v.c_start_time is null and p.patient_id=v.patient_id and v.skip_consultation = 0 and v.visit_id not in(select visit_id from consultation) order by v.visit_id desc;";
											} else if ($user_gender == 'M' and $user_role != 1) {
											$sql= "select p.patient_id,p.name,p.gender,p.age,p.mobile_no,p.reg_date,v.visit_id from patient p,visit v where p.gender='M' and v.visit_date =  '$current_date' and v.c_start_time is null and p.patient_id=v.patient_id and v.skip_consultation = 0 and v.visit_id not in(select visit_id from consultation) order by v.visit_id desc;";	
												} else {												
												$sql= "select p.patient_id,p.name,p.gender,p.age,p.mobile_no,p.reg_date,v.visit_id from patient p,visit v where v.visit_date =  '$current_date' and v.c_start_time is null and p.patient_id=v.patient_id and v.skip_consultation = 0 and v.visit_id not in(select visit_id from consultation) order by v.visit_id desc;";
												} // end of else
						 ...
						 <input type="submit" id="submit_btn" value="Start Consultation">
						 </form>
						 </td> ';
                                               echo'</tr>';
                                                $counter++;
...
?>
                        ...
                        <div class="x_panel">
                                ...
                                <div class="box-body">
                                    <div class="col-md-6">
                                        ...
                                        <div id="patient_details" class="form-group">
 										<?php 
										if ($user_gender == 'F' and $user_role != 1) { 
											$sql1= "select p.patient_id,p.name,p.gender,p.age,p.mobile_no,p.reg_date,v.visit_id, c.end_time from patient p,visit v, consultation c where p.gender='F' and v.visit_date =  '$current_date' and v.c_start_time is not null and c.end_time is null and p.patient_id=v.patient_id and v.visit_id=c.visit_id and v.skip_consultation = 0 order by v.visit_id desc;";
											} else if ($user_gender == 'M' and $user_role != 1) {
											$sql1= "select p.patient_id,p.name,p.gender,p.age,p.mobile_no,p.reg_date,v.visit_id,c.end_time from patient p,visit v,consultation c where p.gender='M' and v.visit_date =  '$current_date' and v.c_start_time is not null and c.end_time is null and p.patient_id=v.patient_id and v.visit_id=c.visit_id and v.skip_consultation = 0 order by v.visit_id desc;";
											} else {
											$sql1= "select p.patient_id,p.name,p.gender,p.age,p.mobile_no,p.reg_date,v.visit_id,c.end_time from patient p,visit v, consultation c where v.visit_date =  '$current_date' and v.c_start_time is not null and c.end_time is null and p.patient_id=v.patient_id and v.visit_id=c.visit_id and v.skip_consultation = 0 order by v.visit_id desc;";	
												} // end of else
						 ...
						 <form action="consultation.php" method="post">
						 <input type="hidden" name="visit_id" value="'.$row['visit_id'].'">
						 <input type="submit" id="submit_btn_resume" value="Resume Consultation">
						 </form>
						 </td> ';
                                               echo'</tr>';
                                                $counter1++;
