...
$sql2= "select gender from patient where patient_id =  $patient_id;";
  ...
  <div class="container body">
    <div class="main_container">
      ...
      <div class="right_col" role="main">
                ...
                <div class="box-body">
                  <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group"><label>Date</label><span style="color:red">*</span>
        ...
        <!--                              <div class="form-group">Time Slot<span style="color:red">*</span>
											<select id="time_slot" class="form-control">
                                            <option>Select Time Slot</option>
                                             <option value="1">09:00:00 - 09:30:00</option>
                                             <option value="2">09:30:00 - 10:00:00</option>
                                             <option value="3">10:00:00 - 10:30:00</option>
                                            </select>
										</div>-->
...
$.post("ajax.php",{opt: "load_time_slots",appointment_date:appointment_date,gender:gender},
...
window.location.replace("book_appointment.php");
//location.reload();
      }); //end of post
