            ...
            <div class="right_col" role="main">
                    ...
                    <div class="page-title col-xs-12">
                        <div class="title_left">
                            <h3>Report: All Consultations List</h3>
                        </div>
                                ...
                                <div class="box-body">
                                    <div class="col-md-6">
                                        ...
                                        <div id="patient_details" class="form-group">
 											<?php 
                                           $sql= "select p.patient_id,p.name,p.gender,p.age,p.mobile_no,p.reg_date,v.visit_id,v.visit_date,c.end_time,u.name consultant_name from patient p,visit v,consultation c,users u where p.patient_id=v.patient_id and v.visit_id = c.visit_id order by v.visit_id and c.consultant_id=u.user_id;";
