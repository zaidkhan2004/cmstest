            ...
            <div class="right_col" role="main">
                    ...
                    <div class="page-title col-xs-12">
                        <div class="title_left">
                            <h3>Report: Success Percentage of Cured Diseases by Cupping</h3>
                        </div>
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="x_panel">
                                ...
                                <div class="box-body">
                                    <div class="col-md-6">
                                        ...
                                        <div id="patient_details" class="form-group">
 											<?php 
                                           $sql= "SELECT d.disease_id, d.disease_name, (SUM( vd.improvement_feedback ) / COUNT( vd.improvement_feedback ))/10*100 per FROM visit_diseases vd, diseases d where vd.improvement_feedback is not null and vd.disease_id=d.disease_id group by d.disease_id";
						 ...
						 <td>'.number_format((float)$row['per'], 2, '.', '').'%</td>';
                                               echo'</tr>';
                                                $counter++;
                                                } // end of while 
                                                echo '</tbody></table>	<br>';
