...
<body class="nav-md">
    ...
    <div class="container body">
		...
		$rec_limit = 100;									
		$sql1 = "SELECT count(patient_no) FROM patients where patient_no like 'M%'; ";
        $retval = mysqli_query( $conn,$sql1 );
		 ...
		 $lastPage = ceil($rec_count / $rec_limit);
		  ...
		  //echo 'limit: ' .$rec_limit;
                                           ...
                                           $sql= "select * from patients where patient_no like 'M%' LIMIT $offset, $rec_limit;";
                                            $result = mysqli_query($conn, $sql);
		 ...
		 echo '<a href="edit_view_all_patient_male.php"> First Page </a>  &nbsp; | &nbsp;';
